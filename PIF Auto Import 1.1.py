...
def convert_to_pdf():
    ...
    with Image(filename=tif_file_path) as img:
        img.sequence.extend(img.sequence)  # Make sure to handle all pages
...
def submit():
    ...
    new_file_name = f"PIF_{start_date}-{end_date}.pdf"

    # Set the path to the directory containing the Excel files
    dir_path = r"C:\Users\alex\Desktop\Files\Local Shared Folder\QC_QC_QC\Logs\PIF_Scans"
    ...
    if os.path.isdir(dir_path):
        ...
        network_path_1 = r"S:\Green Fox\QC_QC_QC\Logs\PIF_Scans"
        network_path_2 = r"Z:\QC_QC_QC\Logs\PIF_Scans"
